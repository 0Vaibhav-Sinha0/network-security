...
class DataTransformation:
    """Handles data preprocessing, transformation, and saving transformed datasets."""

    def __init__(self,
                 data_validation_artifact: DataValidationArtifact,
                 data_transformation_config: DataTransformationConfig):
        """Initializes DataTransformation with validation artifact and configuration."""
        try:
    ...
    def read_data(file_path) -> pd.DataFrame:
        """Reads CSV data from given file path and returns a DataFrame."""
        try:
    ...
    def initiate_data_transformation(self) -> DataTransformationArtifact:
        """Executes full transformation pipeline and returns transformation artifacts."""
