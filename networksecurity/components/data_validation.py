...
class DataValidation:
    """Performs schema validation and data drift detection on ingested data."""

    def __init__(self,
                 data_ingestion_artifact: DataIngestionArtifact,
                 data_validation_config: DataValidationConfig):
        """Initializes DataValidation with ingestion artifacts and schema configuration."""
        try:
    ...
    def detect_dataset_drift(self, base_df, current_df, threshold=0.05) -> bool:
        """Detects data drift using KS test and generates a drift report."""
        try:
            status = True
            report = {}
    ...
    def initiate_data_validation(self) -> DataValidationArtifact:
        """Executes validation pipeline including schema check and drift detection."""
        try:
